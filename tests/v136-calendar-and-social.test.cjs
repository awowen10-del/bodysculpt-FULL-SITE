...
const PAGES = ["index.html", "monthly.html", "quarterly.html", "finances.html", "daily.html", "social.html", "ads.html", "schedule.html", "projects.html"];   // v170: eight
...
(async () => {
  ...
  // relaxed once v142 shipped: the newest release's test pins the exact stamp.
  assert.ok(Number(stamp[1]) >= 141, "monthly.html is stamped v141 or later");
  ...
  for (const f of PAGES) {
    ...
    assert.deepStrictEqual(caps, ["Today", "Planning", "Numbers", "Social", "Finances"], label + "five groups (v165 added Numbers), in order");
    assert.ok(/<a href="\/social.html" class="sn-link(?: active)?" title="Content"><svg class="ic"><use href="#ic-camera"\/>/.test(nav[1]),
