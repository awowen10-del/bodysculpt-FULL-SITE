...
(async () => {
  /* ================= 0. the build stamp ================= */
  assert.ok(/<!-- build v104 · anchor-notes-view -->/.test(MONTHLY), "monthly.html stamped v104 · anchor-notes-view");
  assert.ok(/build v104 · anchor-notes-view/.test(WEEKLY), "index.html carries the same stamp");
